...
try{
	...
	//조회수를 꺼내오기 위한 구문
	String sql1="SELECT COUNT from accessories where idx = " + idx;
	...
	String sql = "UPDATE accessories SET title= '"+title+"', WRITER='"+writer+"', CONTENT ='"+content+"', REGDATE = sysdate, count ="+count+" WHERE idx="+idx+"";
