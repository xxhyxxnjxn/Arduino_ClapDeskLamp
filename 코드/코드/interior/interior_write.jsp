    ...
    <body>
        ...
        <table class="table table-bordered">
             <thead>
                ...
                <tbody>
                    <form action="interior_insert.jsp" onsubmit="return formCheck();" method="post" enctype="Multipart/form-data">
                        <tr>
                            <th>제목: </th>
                        ...
                        <tr>
                            <td colspan="2">
                                ...
                                <input type="button" value="글 목록으로... " onclick="InteriorAccessories.jsp"/>
                            </td>
                        </tr>
                    </form>
                </tbody>
