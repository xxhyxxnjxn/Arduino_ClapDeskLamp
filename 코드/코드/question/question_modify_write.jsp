...
<html>
    ...
    <body>
			<%if(session.getAttribute("id")==null){ %>
                ...
                <!--로그인을 하지 않았을 때 session에 id값이 널 값이다 그러므로 alert를 이용해
                     알림창을 띄우고 그 전페이지로 돌아간다.-->
            <% } else { %>
            <div class="container">
                <div id="wrapper">
        ...
        <table class="table table-bordered">
                ...
                <tbody>
					<!--수정할 글의 idx값을 modify에 전송해준다.-->
                    <form action="question_modify.jsp?idx=<%=idx%>" onsubmit="return formCheck();" method="post">
                        <tr>
							<!--제목 입력-->
                            <th>제목: </th>
